...
library(perm)
rm(list = ls())
setwd("C:/Users/cdabo/OneDrive/Escritorio/MITx - DEDP/Data_analysis")
...
var(schools$open)
var(schools$control*schools$open)
var(schools$treatment*schools$open)
variance<-var(schools$treatment*schools$open)+var(schools$control*schools$open)
...
ggplot(schools, aes(x=open,group=treatment,colour=treatment ))+
  stat_ecdf()
