---
title: "Introducción a la Inferencial Causal - Clase 6"
...
### Sin embargo, al correr una regresión para evaluar la diferencia de ingresos entre los que van a la universidad y los que no, conseguimos una diferencia de $`r round(reg1, digits = 0)`.
...
### Al correr una regresión para evaluar la diferencia de ingresos entre los que van a la universidad y los que no **para estudiantes alrededor de la discontinuidad**, conseguimos una diferencia de $`r round(reg2, digits = 0)`.
